...
export default function RecordCard({ aspect, record, date, userId, onUpdate }) {
    ...
    return (
        <div className={`
            ...
            ${score !== ''
                ? 'bg-white border-indigo-200 shadow-[0_4px_20px_-4px_rgba(99,102,241,0.1)] ring-1 ring-indigo-50 transform hover:-translate-y-0.5'
                ...
                <div className="relative flex-1">
                    <input
                        ...
                        className={`
                            ...
                            ${score !== ''
                                ? 'text-indigo-600 bg-indigo-50/50 focus:ring-indigo-500/50'
                                : 'text-slate-400 bg-slate-50 hover:bg-slate-100 focus:bg-white focus:ring-slate-300'
                            }
            ...
            {(showNote || note) && (
                <div className="mt-3 animate-in fade-in slide-in-from-top-2 duration-200">
                    <textarea
                        ...
                        rows={2}
                        className="w-full text-sm rounded-xl border-slate-200 focus:border-indigo-500 focus:ring-indigo-500 bg-slate-50 focus:bg-white transition-all resize-none p-3 leading-relaxed placeholder:text-slate-400 text-slate-700 shadow-inner"
                    />
                </div>
            )}
        </div>
